...
import requests
import os
from flask import Flask         # নতুন কোড: Flask ইম্পোর্ট করুন
from threading import Thread    # নতুন কোড: থ্রেডিং ইম্পোর্ট করুন

# ==== CONFIGURATION ====
BOT_TOKEN = os.environ.get("BOT_TOKEN")
OPENROUTER_API_KEY = os.environ.get("OPENROUTER_API_KEY")

# নিশ্চিত করুন যে টোকেনগুলো লোড হয়েছে
if not BOT_TOKEN or not OPENROUTER_API_KEY:
    print("Error: BOT_TOKEN and OPENROUTER_API_KEY must be set.")
    exit(1)
...
# নতুন কোড: একটি মিনি Flask অ্যাপ তৈরি করুন
app = Flask(__name__)

@app.route('/')
def health_check():
    """Choreo এই এন্ডপয়েন্টটি পিং করে দেখবে যে অ্যাপটি চলছে কিনা।"""
    return "Telegram bot is alive and running!", 200

def run_web_server():
    """Flask ওয়েব সার্ভার চালানোর জন্য ফাংশন।"""
    # Choreo PORT এনভায়রনমেন্ট ভেরিয়েবল সেট করে। আমাদের সেই পোর্টে শুনতে হবে।
    port = int(os.environ.get("PORT", 8080))
    app.run(host='0.0.0.0', port=port)

# ==== TELEGRAM HELPERS (অপরিবর্তিত) ====
...
# ==== MAIN LOOP (পরিবর্তিত) ====
def run_bot_polling():
    """এই ফাংশনটি এখন শুধু বটের মূল লুপটি চালাবে।"""
